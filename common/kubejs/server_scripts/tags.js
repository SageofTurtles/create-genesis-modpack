...
ServerEvents.tags('item', event => {
  ...
  add('forge:heads', 'minecraft:piglin_head')
  ...
  add('genesis:beehives', 'minecraft:bee_nest')
  add('genesis:beehives', 'minecraft:beehive')
  ...
  add('genesis:tillable_coarse_dirt', 'minecraft:coarse_dirt')
  add('genesis:tillable_coarse_dirt', 'minecraft:rooted_dirt')
  add('genesis:tillable_dirt', 'minecraft:dirt_path')
  add('genesis:tillable_dirt', 'minecraft:dirt')
  add('genesis:tillable_dirt', 'minecraft:grass_block')
