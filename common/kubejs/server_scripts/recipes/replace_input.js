ServerEvents.recipes(event => {
  ...
  id('mcwdoors:iron_portcullis', 'minecraft:iron_bars', 'createdeco:industrial_iron_ingot')
  id('mcwdoors:mangrove_bamboo_door', 'minecraft:bamboo', 'minecraft:mangrove_planks')
  id('mcwdoors:metal_reinforced_door', 'minecraft:iron_nugget', 'createdeco:industrial_iron_nugget')
  id('mcwfences:iron_cheval_de_frise', 'minecraft:iron_nugget', 'createaddition:iron_rod')
  id('mcwtrpdoors:bamboo_barrel_trapdoor', 'minecraft:bamboo', 'minecraft:bamboo_planks')
  ...
  id(/mcwdoors:bamboo_(beach|classic|cottage|four_panel|mystic|nether|paper|swamp|tropical|waffle|whispering)_door/, 'minecraft:bamboo', 'minecraft:bamboo_planks')
