ServerEvents.recipes(event => {
  ...
  add('seaplane', ['   A ', 'ABBCD', 'A EEE', 'ABBCD', '   A '], { A: 'immersive_aircraft:sail', B: 'immersive_aircraft:hull', C: 'immersive_aircraft:engine', D: 'immersive_aircraft:propeller', E: '#create:seats' }, 'immersive_aircraft:bamboo_hopper', 1)
  add('spawner', [' AAA ', 'A B A', 'ABCBA', 'A B A', ' AAA '], { A: 'createdeco:netherite_sheet', B: 'minecraft:ender_eye', C: 'minecraft:nether_star' }, 'minecraft:spawner', 1)
