ServerEvents.recipes(event => {
  ...
  three_by_one('doormat', 'farmersdelight:canvas_rug', 'supplementaries:doormat', 1)
  ...
  eight_one('present', 'minecraft:paper', 'create:cardboard', 'supplementaries:present', 1)
  ...
  A_B('advanced_gyroscope', 'create:iron_sheet', 'immersive_aircraft:gyroscope', 'immersive_aircraft:gyroscope_dials', 1)
  A_B('electronic_gyroscope', 'create:golden_sheet', 'immersive_aircraft:gyroscope', 'immersive_aircraft:gyroscope_hud', 1)
  ...
  ABA_CDC('advanced_engine', 'create:brass_sheet', 'create:precision_mechanism', 'create:sturdy_sheet', 'immersive_aircraft:boiler', 'immersive_aircraft:engine', 1)
  ABA_CDC('lava_engine', 'createdeco:industrial_iron_sheet', 'minecraft:lava_bucket', 'create_ironworks:steel_sheet', 'immersive_aircraft:boiler', 'immersive_aircraft:nether_engine', 1)
  ...
  custom('deposit_upgrade', [' A ', 'BCB', 'DED'], { A: 'create:chute', B: 'minecraft:iron_ingot', C: 'sophisticatedbackpacks:upgrade_base', D: 'minecraft:redstone', E: '#forge:chests/wooden' }, 'sophisticatedbackpacks:deposit_upgrade', 1)
  ...
  custom('industrial_iron_window', ['ABA', 'BCB'], { A: 'minecraft:iron_nugget', B: 'createdeco:industrial_iron_ingot', C: '#forge:glass/colorless' }, 'create:industrial_iron_window', 2)
  ...
  custom('ornate_iron_window', [' A ', 'ABA'], { A: 'minecraft:iron_nugget', B: '#forge:glass/colorless' }, 'create:ornate_iron_window', 1)
  custom('peculiar_bell', [' A ', 'BCB', 'B B'], { A: 'create:brass_block', B: 'minecraft:stick', C: 'create:brass_ingot' }, 'create:peculiar_bell', 1)
  custom('pipe_wrench', ['AA', 'AB', ' C'], { A: 'create:golden_sheet', B: 'create:cogwheel', C: 'createaddition:copper_rod' }, 'cmparallelpipes:pipe_wrench', 1)
  ...
  custom('restock_upgrade', [' A ', 'BCB', 'DED'], { A: '#forge:chests/wooden', B: 'minecraft:iron_ingot', C: 'sophisticatedbackpacks:upgrade_base', D: 'minecraft:redstone', E: 'create:chute' }, 'sophisticatedbackpacks:restock_upgrade', 1)
  ...
  custom('steel_boiler', ['ABA', 'CDC', 'AEA'], { A: 'create:iron_sheet', B: 'create:steam_engine', C: 'create_ironworks:steel_sheet', D: 'create:fluid_tank', E: 'create:blaze_burner' }, 'immersive_aircraft:steel_boiler', 1)
  custom('tank_upgrade', ['AAA', 'BCB', 'AAA'], { A: 'create:copper_sheet', B: '#forge:glass/colorless', C: 'sophisticatedbackpacks:upgrade_base' }, 'sophisticatedbackpacks:tank_upgrade', 1)
