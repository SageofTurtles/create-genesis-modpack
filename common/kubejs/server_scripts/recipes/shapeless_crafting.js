ServerEvents.recipes(event => {
  ...
  add('banking_guide', ['create:sturdy_sheet', 'createdeco:gold_coin'], 'numismatics:banking_guide', 1)
  ...
  add('cooking_guide', ['create:sturdy_sheet', 'minecraft:carrot'], 'create_central_kitchen:cooking_guide', 1)
  ...
  add('rope_and_nail', ['farmersdelight:rope', 'minecraft:iron_ingot'], 'comforts:rope_and_nail', 2)
