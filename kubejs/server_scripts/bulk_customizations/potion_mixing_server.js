ServerEvents.recipes(event => {
  ...
  // Splash Strong => Lingering Strong
  strongAllowed.forEach(effect => {
    event.recipes.create.mixing(
  ...
  // Non-Standard Base Effect Recipes
